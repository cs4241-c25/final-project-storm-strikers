...
export const buildings: Record<BuildingType, Building> = { 
  patriot: {
    ...
    parking: { lat: 42.33538, lng: -71.10621, rates: "$5 per hour, max $20 per day" },
    dropOff: { lat: 42.33590, lng: -71.10717 },
  },
  chestnut: {
    _id: "2",
    name: "chestnut",
    ...
    parking: { lat: 42.32630, lng: -71.14965, rates: "$5 per hour, max $20 per day" },
  ...
  faulkner: {
    ...
    parking: { lat: 42.30187, lng: -71.12953, rates: "$7 for the first hour, $3 per additional hour" },
